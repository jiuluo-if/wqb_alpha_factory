...
class AIFactoryRunner:
    ...
    _SESSION_ACTIONS = SESSION_ACTIONS
    _RESULT_STATUSES = RESULT_STATUSES
    _BLOCKER_STOP_ACTIONS = BLOCKER_STOP_ACTIONS
    _TERMINAL_RECONCILE_ACTIONS = TERMINAL_RECONCILE_ACTIONS
    _CONTROL_TOKENS = CONTROL_TOKENS
