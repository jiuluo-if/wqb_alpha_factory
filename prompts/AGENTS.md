...
研究和维护各自只有一个 prompt，且不互相复制契约：

- `maintenance_agent.md`：维护 Agent（architecture、tests、docs、privacy、profiling、dependency、交付）。
- `research_agent.md`：Research Agent（hypothesis、实验选择、结果解释）。
